          ...
          <table className="bordered centered highlight responsive-table">
            <tbody>
              <tr>
                ...
                <td><img src="/img/certificates/css3.gif" alt="CSS 3" /></td>
                <td><img src="/img/certificates/html5.gif" alt="HTML 5" /></td>
              </tr>
              <tr>
                <td><img src="/img/certificates/htmlprogrammer.gif" alt="HTML 4.0" /></td>
                <td><img src="/img/certificates/javascript18.gif" alt="Javascript 1.8" /></td>
                <td><img src="/img/certificates/linuxadministrator.gif" alt="Linux Administration (General)" /></td>
              </tr>
              <tr>
                <td><img src="/img/certificates/ooconcepts.gif" alt="OO Concepts" /></td>
                <td><img src="/img/certificates/oodesignpatterns.gif" alt="OO Design Patterns" /></td>
                <td><img src="/img/certificates/php5.gif" alt="PHP 5" /></td>
              </tr>
              <tr>
                <td><img src="/img/certificates/php53.gif" alt="PHP 5.3" /></td>
                <td><img src="/img/certificates/php54.gif" alt="PHP 5.4" /></td>
                <td><img src="/img/certificates/php55.gif" alt="PHP 5.5" /></td>
              </tr>
              <tr>
                <td><img src="/img/certificates/programmingconcepts.gif" alt="Programming Concepts" /></td>
                <td><img src="/img/certificates/python24.gif" alt="Python 2.4" /></td>
                <td><img src="/img/certificates/rdbmsdeveloper.gif" alt="RDBMS Concepts" /></td>
              </tr>
              <tr>
                <td><img src="/img/certificates/sqlansi.gif" alt="SQL (ANSI)" /></td>
                <td><img src="/img/certificates/visualbasic2008fundamentals.gif" alt="Visual Basic 2008 Fundamentals" /></td>
                <td><img src="/img/certificates/webdesignconcepts.gif" alt="Web Design Concepts" /></td>
              </tr>
              <tr>
                <td><img src="/img/certificates/webdevelopmentconcepts.gif" alt="Web Development Concepts" /></td>
                <td><img src="/img/certificates/xhtml11.gif" alt="XHTML 1.1" /></td>
                <td><img src="/img/certificates/webdeveloperbcip.gif" alt="Web Developer (BCIP)" /></td>
              </tr>
            </tbody>
          </table>
